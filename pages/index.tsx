        ...
        <main className='w-full px-5 sm:px-12'>
          ...
          <section className="mt-48 w-full relative" data-scroll-section>
            <div className="block sm:grid grid-cols-6 gap-5">
              <h1 className="font-sans text-2xl sm:text-3xl">About Me</h1><br />
              <div className='font-bold text-right sm:text-left w-full ml-auto text-3xl col-start-3 col-end-7'>
                <h1>
