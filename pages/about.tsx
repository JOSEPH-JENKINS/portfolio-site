...
const About: NextPage = () => {
    return (
        <motion.div exit={{ y: -50 }} initial={{ y: -50 }} animate={{ y: 0 }} className='w-full bg-[#121212] text-[#f4f4f4]'>
            <Head>
            ...
            <main className='w-full overflow-x-hidden'>
                ...
                <section className='h-screen w-screen px-5 sm:px-12 relative grid grid-cols-4 grid-rows-5 sm:grid-cols-12 gap-5 about'>
                    ...
                    <div className="col-start-1 col-end-4 -z-10 bg-white row-start-3 row-end-7 relative about-img">
